...
func (c *servicesClient) ChatService(ctx context.Context, opts ...grpc.CallOption) (Services_ChatServiceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Services_ServiceDesc.Streams[0], "/chat_server.Services/ChatService", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *servicesChatServiceClient) Send(m *FormClient) error {
...
func (x *servicesChatServiceServer) Recv() (*FormClient, error) {
	m := new(FormClient)
...
var Services_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chat_server.Services",
